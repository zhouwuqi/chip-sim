...
// --- dark / light theme (chrome via CSS class, canvas via renderer palette) ---
const THEME_KEY = 'chipsim:theme';
let theme: 'dark' | 'light' = localStorage.getItem(THEME_KEY) === 'light' ? 'light' : 'dark';
